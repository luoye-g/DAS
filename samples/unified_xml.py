...
sub_class = None
is_hard = 'No'
sli_path = os.path.join(out_path, '3DHistech/Shengfuyou_2th/Positive')
xml_path = os.path.join(out_path, '3DHistech/Shengfuyou_2th/Labelfiles/XML')
