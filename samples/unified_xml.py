...
from format_conversion.xml_tools import merge_anno, read_xml_by_path
...
sub_class = None
is_hard = 'No'
sli_path = os.path.join(out_path, 'SZSQ/Tongji_6th/positive')
xml_path = os.path.join(out_path, 'SZSQ/Labelfiles/xml_Tongji_6th/xml_Tongji_6th/pos')
